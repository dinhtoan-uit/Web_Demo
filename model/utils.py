    ...
    def __getitem__(self, index):
        ...
        for i in range(self._time_step+self._num_pred):
            try:
              ...
              raise Exception("An exception occurred index:"+str(index)+" video name:"+str(video_name)+" frame name:"+str(frame_name)+" i:"+str(i)+" path:"+str(len(self.videos[video_name]['frame'])))
